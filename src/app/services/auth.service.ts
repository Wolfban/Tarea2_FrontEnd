...
import { ILoginResponse, IResponse, IUser, IRole, IAuthority } from '../interfaces';
...
export class AuthService {
  ...
  public areActionsAvailable(routeAuthorities: string[]): boolean  {
    ...
    if (userAuthorities?.some(item => item.authority == IRole.superAdmin || item.authority == IRole.superAdmin)) {
      isAdmin = userAuthorities?.some(item => item.authority == IRole.superAdmin || item.authority == IRole.superAdmin);
    }          
